...
<p><input value="action" name="reducerAction" size="10" type="textfield">
 ...
 <input value="property" name="reducerProperty" size="10" type="textfield"></p>
